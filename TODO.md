...
- [ ] Expand varying support beyond the initial `vec2` perspective-interpolated profile.
  ...
  - [ ] General multiple-varying combinations and expressions remain unsupported.
    The generic assignment path now links matching `varying vec2`,
    ...
    varying expressions, generic texture use, fragment/builtin-output swizzle
    writes, and broader linkage semantics remain unsupported.
