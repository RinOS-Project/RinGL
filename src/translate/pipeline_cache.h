...
#define RINGL_NATIVE_PRIMITIVE_LINE_LIST     3u
#define RINGL_NATIVE_PRIMITIVE_LINE_STRIP    4u
#define RINGL_NATIVE_PRIMITIVE_LINE_LOOP     5u
#define RINGL_NATIVE_PRIMITIVE_TRIANGLE_STRIP 6u
#define RINGL_NATIVE_PRIMITIVE_TRIANGLE_FAN   7u
#define RINGL_PIPELINE_CACHE_CAPACITY 32u
#define RINGL_PIPELINE_MAX_SCALAR_VARYINGS RINGL_MAX_VARYING_COMPONENTS
