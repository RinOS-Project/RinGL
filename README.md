...
attribute component assignment, a vertex `gl_PointSize` Float32 occupies the
...
vertex RSH1 module, and an attribute component is stored directly from its
vertex RSH1 register before the generic backend finite-checks and clamps the
