...
#define RINGL_GLSL_MAX_UNIFORMS \
    (RINGL_GLSL_MAX_FLOAT_UNIFORMS + RINGL_GLSL_MAX_INT_UNIFORMS + RINGL_GLSL_MAX_BOOL_UNIFORMS + \
     RINGL_GLSL_MAX_BVEC2_UNIFORMS + RINGL_GLSL_MAX_BVEC3_UNIFORMS + RINGL_GLSL_MAX_BVEC4_UNIFORMS + \
     ...
     RINGL_GLSL_MAX_IVEC4_UNIFORMS + RINGL_GLSL_MAX_MAT2_UNIFORMS + \
     RINGL_GLSL_MAX_MAT3_UNIFORMS + RINGL_GLSL_MAX_MAT4_UNIFORMS)
